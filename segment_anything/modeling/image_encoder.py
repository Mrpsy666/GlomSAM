...
from .cnn_branch import ResNetCNNBranch, FusionWithSE
...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        self.cnn_branch =  ResNetCNNBranch(out_chans=cnn_chans)

        self.fusion_module = FusionWithSE(cnn_chans, cnn_chans, out_chans)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        #(B,256,256,256)
        cnn_features = self.cnn_branch(inp)
